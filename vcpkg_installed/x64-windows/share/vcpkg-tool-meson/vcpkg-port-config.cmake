...
set(meson_short_hash 7fcb19)

# Setup meson:
set(program MESON)
set(program_version 1.8.2)
...
if(NOT SCRIPT_MESON)
    ...
    z_vcpkg_apply_patches(
        ...
        PATCHES
            ...
            "${CMAKE_CURRENT_LIST_DIR}/fix-libcpp-enable-assertions.patch"
            "${CMAKE_CURRENT_LIST_DIR}/universal-osx.patch"
    )
