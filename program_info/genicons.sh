...
LAUNCHER_APPID="ru.pineconemc.launcher"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/pineconemc_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/pineconemc_"*".png"

    rm pineconemc.ico && icotool -o pineconemc.ico -c \
        "$d/pineconemc_256.png"  \
        "$d/pineconemc_128.png"  \
        "$d/pineconemc_64.png"   \
        "$d/pineconemc_48.png"   \
        "$d/pineconemc_32.png"   \
        "$d/pineconemc_24.png"   \
